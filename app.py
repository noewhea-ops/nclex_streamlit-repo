...
# ---------- Page setup ----------
st.set_page_config(
    page_title="Sweet Bean — NCLEX Coach",
    page_icon="sweet_bean_logo.png",   # uses the uploaded logo in the repo root
    layout="centered"
)

# Header + logo
st.title("🩺 Sweet Bean — NCLEX Coach")
st.caption("Daily practice with clean rationales. Educational use only.")
# show logo under the title (adjust width to your taste)
if os.path.exists("sweet_bean_logo.png"):
    st.image("sweet_bean_logo.png", width=160)
...
st.sidebar.markdown("---")
st.sidebar.write("© Sweet Bean • Study use only • Not medical advice.")
